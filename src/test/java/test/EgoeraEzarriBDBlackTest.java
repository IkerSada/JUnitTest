...
public class EgoeraEzarriBDBlackTest {
    ...
    // Test 6: Egoera hutsa - PASATU BEHAR DU (berdea) - Metodoak onartzen du
    @Test
    public void testEgoeraHutsa() {
        try {
            ...
            assertEquals("", updatedErreklamazioa.getEgoera()); // Egoera aldatu da hutsara
    ...
    // Test 7: Egoera baliogabea - PASATU BEHAR DU (berdea) - Metodoak onartzen du
    @Test
    ...
    // Test 10: Diru negatiboa erreserban - PASATU BEHAR DU (berdea) - Metodoak onartzen du
    @Test
